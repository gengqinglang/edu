...
const EDUCATION_TRANSITION_RULES = [
  ...
  { from: { stage: '初中', level: '公立' }, to: { stage: '高中', level: '海外高中' }, feasibility: 'feasible', conditions: ['通过海外高中申请', '取得合格的语言成绩', '获得签证'], description: '早期转轨路径，需提前准备', prevalence: 0.2 },
  ...
  { from: { stage: '初中', level: '普通私立' }, to: { stage: '高中', level: '海外高中' }, feasibility: 'feasible', conditions: ['通过海外高中申请', '取得合格的语言成绩', '获得签证'], description: '早期转轨路径，需提前准备', prevalence: 0.2 },
  ...
  { from: { stage: '初中', level: '民办双语' }, to: { stage: '高中', level: '海外高中' }, feasibility: 'feasible', conditions: ['通过海外高中申请', '取得合格的语言成绩', '获得签证'], description: '早期转轨路径，需提前准备', prevalence: 0.2 },
  ...
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '国内公办' }, feasibility: 'infeasible', conditions: ['无国内学籍，无法参加高考'], description: '路径锁定，无法回头', prevalence: 0.1 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '国内民办' }, feasibility: 'infeasible', conditions: ['无国内学籍，无法参加高考'], description: '路径锁定，无法回头', prevalence: 0.1 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '海外大学' }, feasibility: 'feasible', conditions: ['完成海外高中课程', '取得合格的标准化考试成绩', '完成申请'], description: '主流出口，目标明确', prevalence: 0.4 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '中外合作办学' }, feasibility: 'feasible', conditions: ['用海外高中成绩申请'], description: '良好的备选路径', prevalence: 0.3 },
  ...
  { from: { stage: '大学', level: '国内民办' }, to: { stage: '研究生', level: '海外硕士' }, feasibility: 'feasible', conditions: ['参加全国硕士研究生招生考试（考研）'], description: '常见路径', prevalence: 0.4 },
