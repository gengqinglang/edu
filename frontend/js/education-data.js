...
const EDUCATION_TRANSITION_RULES = [
  ...
  { from: { stage: '初中', level: '民办双语' }, to: { stage: '高中', level: '海外高中' }, feasibility: 'feasible', conditions: ['通过海外高中申请', '取得合格的语言成绩', '获得签证'], description: '早期转轨路径，英语基础较好', prevalence: 0.3 },
  { from: { stage: '初中', level: '外籍人员子女学校' }, to: { stage: '高中', level: '海外高中' }, feasibility: 'feasible', conditions: ['通过海外高中申请', '获得签证'], description: '自然衔接，语言优势明显', prevalence: 0.4 },
  ...
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '国内公办' }, feasibility: 'infeasible', conditions: ['无法参加高考'], description: '政策不允许', prevalence: 0.1 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '国内民办' }, feasibility: 'infeasible', conditions: ['无法参加高考'], description: '政策不允许', prevalence: 0.1 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '海外大学' }, feasibility: 'feasible', conditions: ['完成海外高中课程', '取得合格的语言成绩', '完成申请'], description: '主流出口，目标明确', prevalence: 0.4 },
  { from: { stage: '高中', level: '海外高中' }, to: { stage: '大学', level: '中外合作办学' }, feasibility: 'feasible', conditions: ['用海外高中成绩申请'], description: '可能的备选路径', prevalence: 0.3 },
